...
This saves a *.anim* file as a new asset. Crack this open to see a wall of keyframes — six per frame (position + rotation), for each crate. It's a hefty file.[^1]
...
<small>
    Code snippets [on GitHub](https://github.com/mminer/blog-code/tree/master/recording-physics-animation-in-unity).
</small>

[^1]: This small example resulted in a 4 MB animation clip. Consider pruning keyframes if you don't need an exact frame-by-frame copy of your simulation.
