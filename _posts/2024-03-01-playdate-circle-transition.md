...
Today in [Playdate](https://play.date) development, I wanted a decidedly old school transition between levels. You know that cheesy effect in silent film where the frame goes black via a shrinking circle? That's an [iris shot](https://en.wikipedia.org/wiki/Iris_shot) my friend. That's what I want.
...
<small>
    Sample project [on GitHub](https://github.com/mminer/playdate-circle-transition).
</small>
